			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2 text">
						<h1 style="font-size: 50px">后台权限管理系统</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 form-box">
						<div class="form-top">
							<div class="form-top-left">
								...
								<p style="font-size: 15px">请输入你的用户名和密码:</p>
							</div>
							...
							<form class="layui-form" method="post" action="UserLogin">
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input id="namea" type="text" name="username"
								...
								<p>
									<a href="javascript:;" class="fr register">立即注册</a>
								</p>
							</form>
						</div>
					</div>
	...
	<div style="display: none;" id="reg" class="change-pas-box">
		...
		<form class="layui-form" method="post"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input id="email2" type="text" name="email2" lay-verify="email"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input id="tel2" type="tel" name="phone2" lay-verify="required|phone"
		...
		layui.use([ 'form','layedit', 'laydate', 'layer' ], function() {
			...
			//自定义验证规则
			  ...
			  form.on('submit(demo2)', function(data){
				  $.ajax({
			          url: '<%=request.getContextPath()%>/UserReg',
			          type: "POST",
			          async: false,
			          data: {
